      ...
      <Card className="w-full max-w-md relative z-10 bg-codedex-900/90 border-codedex-500/50 backdrop-blur-sm">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardDescription className="text-codedex-300">
            Create your account to start your dev journey
          </CardDescription>
        </CardHeader>
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="name" className="text-codedex-200">Name</Label>
              <Input
                id="name"
                type="text"
          ...
          <CardFooter className="flex flex-col space-y-4">
            ...
            <p className="text-sm text-codedex-400 text-center">
              ...
              <Link href="/sign-in" className="text-codedex-400 hover:text-codedex-300 font-semibold">
                Sign In
              </Link>
            </p>
          </CardFooter>
